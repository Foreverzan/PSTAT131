...
```{r}
ggplot(mpg, aes(x=hwy)) + geom_histogram(fill="blue") + xlab("highway miles per gallon") + ggtitle("Histogram of highway miles per gallon")
```
\
...
```{r}
ggplot(mpg, aes(x=hwy, y=cty)) + geom_point() + xlab("Highway miles per gallon") + ylab("City miles per gallon") +ggtitle("Scatterplot of highway miles per gallon regrading city miles per gallon")
```
\
...
```{r}
# original plot 
ggplot(mpg, aes(x= manufacturer)) + geom_bar(stat = "count", fill="blue") + ggtitle("Bar plot of manufacturer")
```
```{r}
# Filp and order plot
mpg %>% 
	...
	ggplot(aes(y = reorder(manufacturer,(count)), x = count)) + 
		geom_bar(stat = 'identity',fill="blue" ) + xlab("weight") +ylab("manufacturer") + ggtitle("Bar plot of manufacturer (order)")
```
\
...
```{r}
ggplot(mpg, aes( x=hwy, y=factor(cyl))) + geom_boxplot(fill="green") + xlab("Highway miles per gallon") + ylab("Number of cylinders") +ggtitle("Boxplot of highway miles per gallon regrading Number of cylinders")
```
\
