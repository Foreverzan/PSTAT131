...
```{r}
# Replace survived class to "1","0"
#titanic$sex <- ifelse(titanic$sex == "Yes",1,0)
#head(titanic)
...
* survived negative correlate to sex, pclass
...
```{r}
# Calculate AUC
auc(titanic_test$survived, prediction$.pred_No)
```
