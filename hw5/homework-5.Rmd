...
![Fig 1. Vulpix, a Fire-type fox Pokémon from Generation 1.](/Users/yonghengzan/Desktop/131/vulpix.png){width="196"}
...
_Class: 18._\
_The flying type with few Pokemon._ \
...
```
_Each resample is created within the stratification variable that each fold is an appropriate representative of the original data._
...
_There will be 500 models in total._\
...
autoplot(tune_res)
```
_I notice that less lasso penalty produce higher accuracy and roc_auc. And smaller mixture produce better accuracy and ROC AUC._
...
_The overall roc_auc is 0.70 which is not good enough. The model is best at predicting Normal type and water is the worst.This might due to the resample techniques._
